...
class DynastyFeedback: UIViewController {
...
class DynastyFeedbackVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        resetStars()
        navigationController?.navigationBar.isHidden = false
       // navigationItem.title = "DynastyFeedback"
    }
...
class DynastySettingVC: UIViewController {
